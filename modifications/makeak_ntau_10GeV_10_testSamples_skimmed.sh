...
for file in `cat filelists/ntau_10GeV_10_testSamples.txt`; do
  ...
  for i in `seq 0 19`; do
    ...
    echo bsub -q s -o job/skimmed/ntau_10GeV_10/output.%J -e job/skimmed/ntau_10GeV_10/errors.%J "python LCIO2ak2_edit_skimmed.py ${lcio_path}${file} ${datadir}/awkd_testSamples/${filename}_${S}.h5 5 ${a} > ${datadir}/log_testSamples/${filename}_${S}.log"
