...
basedir=../gpfs/data/skimmed/pandora/uds91/awkd
jobdir=job/skimmed/pandora/uds91
...
for file in `cat filelists/uds91.list`; do
    ...
    bsub -q s -o ${jobdir}/concat/output.%J -e ${jobdir}/concat/errors.%J "python concat_awkward.py temp/temp.list ${basedir}/concat/uds91_${num}.h5"
