...
mkdir -p ${datadir}/log_validSamples/
mkdir -p ${datadir}/awkd_validSamples/
mkdir -p job/skimmed/ntau_10GeV_10

lcio_path=/home/ilc/suehara/gpfs/doublePG/example/data/ntau_10GeV_10/reco/


for file in `cat filelists/ntau_10GeV_10_validSamples.txt`; do
  # echo $file
  filename_d=${file%.*}
  filename=${filename_d##*/}
  echo ${filename}
  ...
  for i in `seq 0 19`; do
    ...
    bsub -q s -o job/skimmed/ntau_10GeV_10/output.%J -e job/skimmed/ntau_10GeV_10/errors.%J "python LCIO2ak2_edit_skimmed.py ${lcio_path}${file} ${datadir}/awkd_validSamples/${filename}_${S}.h5 5 ${a} > ${datadir}/log_validSamples/${filename}_${S}.log"
  ...
  # echo bsub -q s -o job/skimmed/ntau_10GeV_10/output.%J -e job/skimmed/ntau_10GeV_10/errors.%J "python LCIO2ak2_edit_skimmed.py ${lcio_path}${file} ${datadir}/awkd_validSamples/${filename}.h5 1000 0 > ${datadir}/log_validSamples/${filename}.log"
