...
basedir=../gpfs/data/skimmed/${type}/awkd_validSamples
# basedir=../gpfs/data/skimmed/ntau_10GeV_10/awkd_validSamples
...
for file in `cat filelists/ntau_10GeV_10_validSamples.txt`; do
    ...
    echo bsub -q s -o job/skimmed/${type}/concat/output.%J -e job/skimmed/${type}/concat/errors.%J "python concat_awkward.py temp/temp.list ${basedir}/concat/${type}_${num}.h5"
