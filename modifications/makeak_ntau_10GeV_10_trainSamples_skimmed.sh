...
mkdir -p ${datadir}/log_trainSamples/
mkdir -p ${datadir}/awkd_trainSamples/
mkdir -p job/skimmed/ntau_10GeV_10

lcio_path=/home/ilc/suehara/gpfs/doublePG/example/data/ntau_10GeV_10/reco/


for file in `cat filelists/ntau_10GeV_10_trainSamples.txt`; do
  # echo $file
  filename_d=${file%.*}
  filename=${filename_d##*/}
  echo ${filename}
  ...
  for i in `seq 0 19`; do
    ...
    echo bsub -q s -o job/skimmed/ntau_10GeV_10/output.%J -e job/skimmed/ntau_10GeV_10/errors.%J "python LCIO2ak2_edit_skimmed.py ${lcio_path}${file} ${datadir}/awkd_trainSamples/${filename}_${S}.h5 5 ${a} > ${datadir}/log_trainSamples/${filename}_${S}.log"
  ...
  # echo bsub -q s -o job/skimmed/ntau_10GeV_10/output.%J -e job/skimmed/ntau_10GeV_10/errors.%J "python LCIO2ak2_edit_skimmed.py ${lcio_path}${file} ${datadir}/awkd_trainSamples/${filename}.h5 1000 0 > ${datadir}/log_trainSamples/${filename}.log"
